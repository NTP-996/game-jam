...
-- This completely nukes the entire database and starts over
-- Date: 2024-12-16

-- =====================================================
-- NUCLEAR DELETE - REMOVE EVERYTHING
-- =====================================================

-- Delete all storage policies first
DO $$
DECLARE
    pol RECORD;
BEGIN
...
-- Delete all public table policies
DO $$
DECLARE
    pol RECORD;
BEGIN
...
DELETE FROM storage.objects WHERE bucket_id IN ('game-banners', 'game-logos', 'game-screenshots');

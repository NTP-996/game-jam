-- Fresh Start Schema for Solana Game Jam 2025
-- This completely resets the database and creates only what we need
-- Date: 2024-12-16
...
CREATE TABLE public.projects (
  ...
  team_id UUID REFERENCES public.teams(id) ON DELETE SET NULL, -- Link to team if it's a team project
...
-- 1. User profiles with skills and team preferences
-- 2. Teams with full invitation system
-- 3. Projects that can be individual or team-based
-- 4. Image storage with proper security
-- 5. Clean views for public browsing
-- 6. Proper RLS for data security 